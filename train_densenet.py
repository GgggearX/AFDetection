...
def train_fold(x_train, y_train, x_val, y_val, fold, args):
    ...
    # except ImportError:
    #     raise ImportError("需要安装 imblearn 库 来使用 SMOTE")
    ...
    callbacks = [
        ...
        ModelCheckpoint(os.path.join(model_dir, f'model_best_densenet_fold_{fold}.hdf5'),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='data/physionet/training2017', help='数据目录路径')
    parser.add_argument('--reference_file', type=str, default='data/REFERENCE-v3.csv', help='标签文件路径')
    ...
    parser.add_argument('--model_dir', type=str, default='DenseNet', help='模型保存目录')
